...
a persistence unit "EXAMENMalkiYupankiPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EXAMENMalkiYupanki\pom.xml":
...
artifact ("EXAMENMalkiYupanki.war") is already built. You can build
